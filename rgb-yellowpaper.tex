...
However, all existing attempts for building permissionless smart contracts,
...
Enums (sum types) are represented as sets, and enum variables are represented as values
...
It represents a significant development from the original ideas of Peter Todd [\SUS1, \SUS2],
bringing support for seal composition into graph structures with interdependencies,
...
It is provided in full in the Appendix \ref{ap:impl}.
