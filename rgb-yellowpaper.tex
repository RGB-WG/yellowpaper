...
comparing to a traditional blockchain approach \cite{Prime}.
Use of Prime also allows to avoid all the complexities associated
with the Bitcoin TxO seals construct (Section \ref{Seals}).

The complete formal specification of the RGB on Prime (RGB$^\prime$, for short)
is outside of the scope of the current paper and will be part of the future work.
For now, we will briefly define the main differences from RGB on Bitcoin (RG\bitcoin, for short)
...
It is provided in full in Appendix \ref{AnnexC}.
